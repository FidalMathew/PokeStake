export default function evaluate(circuit, inputs, arithmetic) {
    ...
    const wires = new Array(wireCount).fill(arithmetic.init(0));
    ...
    while (true) {
        ...
        const outputIndexes = parts.slice(2 + inputLen, 2 + inputLen + outputLen).map(Number);
    ...
    const res = {};
    for (const [name, wireIndex] of Object.entries(circuit.info.output_name_to_wire_index)) {
